 ...
 **/
extern void get_str_list(const std::string& str, std::list<std::string>& str_list);
 ...
 * @param [out] str_list List modified containing str after it has been split
 **/
extern void get_str_list(const std::string& str, const char* delims, std::list<std::string>& str_list);
 ...
 **/
extern void get_str_vec(const std::string& str, std::vector<std::string>& str_vec);
 ...
 * @param [out] str_vec Vector modified containing str after it has been split
 **/
extern void get_str_vec(const std::string& str, const char* delims, std::vector<std::string>& str_vec);
 ...
 * @param [out] str_list Set modified containing str after it has been split
 **/
extern void get_str_set(const std::string& str, const char* delims, std::set<std::string>& str_list);
