...
struct cli_group_t
{
    ...
    cli_group_t(unsigned _client_count = 100, unsigned _client_wait = 0, unsigned _client_total_ops = 1000,
                unsigned _client_server_select_range = 10, unsigned _client_iops_goal = 50,
                unsigned _client_outstanding_ops = 100, double _client_reservation = 20.0, double _client_limit = 60.0,
                double _client_weight = 1.0, Cost _client_req_cost = 1u)
    ...
    friend std::ostream& operator<<(std::ostream& out, const cli_group_t& cli_group)
    {
...
struct srv_group_t
{
    ...
    srv_group_t(unsigned _server_count = 100, unsigned _server_iops = 40, unsigned _server_threads = 1)
    ...
    friend std::ostream& operator<<(std::ostream& out, const srv_group_t& srv_group)
    {
...
struct sim_config_t
{
    ...
    sim_config_t(unsigned _server_groups = 1, unsigned _client_groups = 1, bool _server_random_selection = false,
                 bool _server_soft_limit = true, double _anticipation_timeout = 0.0)
    ...
    friend std::ostream& operator<<(std::ostream& out, const sim_config_t& sim_config)
    {
        out << "server_groups = " << sim_config.server_groups << "\n"
            ...
            << std::fixed << std::setprecision(3) << "anticipation_timeout = " << sim_config.anticipation_timeout;
        return out;
    }
};   // class sim_config_t
